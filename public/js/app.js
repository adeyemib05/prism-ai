...
var Analyze = (function() {
  ...
  function loadDemo() {
    ...
    var demoMd = [
      '### \uD83D\uDD0E Prism Intelligence: BTC',
      '',
      '**BTC** | Price: $64.45K | 24h: \uD83D\uDFE2 +4.25%',
      '',
      '#### \u26A0\uFE0F Risk Shield: LOW (Score: 12/100)',
      'Bitcoin demonstrates massive liquidity and steady institutional volume patterns. No significant risk flags detected. Well-established market presence with deep order books across all major exchanges.',
      '',
      '**Key Risk Factors Detected:**',
      '- None detected',
      '',
      '#### \uD83D\uDCCA Market Structure: BULLISH',
      'The market structure indicates a continuation of the bullish macro trend. Price is holding firmly above the critical $62K support zone with strong buying pressure absorbing minor pullbacks.',
      '',
      ...
      '**Confidence: 88/100**',
      '',
      'Low risk score of 12 combined with a strong bullish trend and high trading volume supports an accumulate verdict. Entry is set to await a minor pullback, with a stop loss below the key $62K structural support.',
      '',
      '**Actionable Levels**',
      ...
      '- **Risk/Reward:** 1:2.5',
      '',
      '*Generated by Prism using COMBINED data (OKX + CoinGecko). This is a demo analysis.*'
    ].join('\n');
